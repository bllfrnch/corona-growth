...
export CORONA_DAILY_REPORTS_DIR=./$CORONA_GIT_REPO_NAME/csse_covid_19_data/csse_covid_19_daily_reports
export CORONA_DAILY_REPORTS_US_DIR=./$CORONA_GIT_REPO_NAME/csse_covid_19_data/csse_covid_19_daily_reports_us
